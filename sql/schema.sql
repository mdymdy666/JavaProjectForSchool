...
CREATE TABLE IF NOT EXISTS user_behaviors (
  ...
  CONSTRAINT fk_user_behaviors_product FOREIGN KEY (product_id) REFERENCES products(id),
  CONSTRAINT fk_user_behaviors_category FOREIGN KEY (category_id) REFERENCES categories(id),
  INDEX idx_user_behaviors_user_created (user_id, created_at),
  INDEX idx_user_behaviors_product (product_id)
);
...
CREATE TABLE IF NOT EXISTS reports (
  ...
  CONSTRAINT fk_reports_admin FOREIGN KEY (admin_id) REFERENCES users(id)
);
